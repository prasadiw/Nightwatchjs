...
module.exports = {
			...
			.element('css selector', 'div.panel.hidden > div#imagelist > div.posts.br5.posts-search.first-child > div.cards >  div.post', function (result) {
				if (result.status != -1) { //If images results are found, move to first image
					browser.moveToElement('div.panel.hidden > div#imagelist > div.posts.br5.posts-search.first-child > div.cards >  div:nth-child(1)', 65.5, 100, function () {//load the hover over text of the first image result
						browser.waitForElementVisible('div.panel.hidden > div#imagelist > div.posts.br5.posts-search.first-child > div.cards >  div:nth-child(1) > div.hover', 5000)
						browser.pause(2000)
						//assert hover text for the search text 
						browser.assert.containsText('div.panel.hidden > div#imagelist > div.posts.br5.posts-search.first-child > div.cards >  div:nth-child(1) >div.hover > p > span.matched-search-term', searchtext)
					})
				}
			});
	},
	...
	'Test Auto Complete Search with TAGS': function (browser) {
		browser
			.waitForElementVisible('body', 1000)
			.waitForElementVisible('#global-search-container', 1000)
			.click('#global-search-container > div.search-container.search-focused > form.search-form > div.search-icon-container > div.icon-search.searchable')//click on search control
			...
			.element('css selector', '#global-search-container > div.search-container.search-focused > div.global-search-autocomplete > div:nth-child(1) > div.tag-icon', function (result) {
				if (result.status != -1) { //wait for auto suggestions using Tags
					...
					//verify header for the search text
			        browser.assert.containsText('#content > div.sentence-sorting > #section > div.selection > div.name', searchtext)
			        //verify loading of the result panel. this have to be passed even when no results found for the search criteria.
